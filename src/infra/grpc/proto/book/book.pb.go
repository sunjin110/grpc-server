...
type BookDeleteHistoryListReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	BookDeleteHistoryList []*BookDeleteHistoryInfo `protobuf:"bytes,1,rep,name=book_delete_history_list,json=bookDeleteHistoryList,proto3" json:"book_delete_history_list,omitempty"`
}

func (x *BookDeleteHistoryListReply) Reset() {
	*x = BookDeleteHistoryListReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *BookDeleteHistoryListReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BookDeleteHistoryListReply) ProtoMessage() {}

func (x *BookDeleteHistoryListReply) ProtoReflect() protoreflect.Message {
	mi := &file_book_book_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BookDeleteHistoryListReply.ProtoReflect.Descriptor instead.
func (*BookDeleteHistoryListReply) Descriptor() ([]byte, []int) {
	return file_book_book_proto_rawDescGZIP(), []int{5}
}

func (x *BookDeleteHistoryListReply) GetBookDeleteHistoryList() []*BookDeleteHistoryInfo {
	if x != nil {
		return x.BookDeleteHistoryList
	}
	return nil
}

type BookDeleteHistoryInfo struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *BookDeleteHistoryInfo) Reset() {
	*x = BookDeleteHistoryInfo{}
	if protoimpl.UnsafeEnabled {
...
func (x *BookDeleteHistoryInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BookDeleteHistoryInfo) ProtoMessage() {}

func (x *BookDeleteHistoryInfo) ProtoReflect() protoreflect.Message {
	mi := &file_book_book_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BookDeleteHistoryInfo.ProtoReflect.Descriptor instead.
func (*BookDeleteHistoryInfo) Descriptor() ([]byte, []int) {
	return file_book_book_proto_rawDescGZIP(), []int{6}
}

func (x *BookDeleteHistoryInfo) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *BookDeleteHistoryInfo) GetUser() string {
	if x != nil {
		return x.User
	}
	return ""
...
var file_book_book_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_book_book_proto_goTypes = []interface{}{
	...
	(*BookDeleteHistoryListReply)(nil), // 5: book.BookDeleteHistoryListReply
	(*BookDeleteHistoryInfo)(nil),      // 6: book.BookDeleteHistoryInfo
...
var file_book_book_proto_depIdxs = []int32{
	...
	6, // 1: book.BookDeleteHistoryListReply.book_delete_history_list:type_name -> book.BookDeleteHistoryInfo
	...
	7, // 6: book.BookRpc.BookDeleteHistoryList:input_type -> comm.Empty
	...
	5, // 11: book.BookRpc.BookDeleteHistoryList:output_type -> book.BookDeleteHistoryListReply
...
func file_book_book_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_book_book_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BookDeleteHistoryListReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_book_book_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BookDeleteHistoryInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type BookRpcClient interface {
	...
	BookDeleteHistoryList(ctx context.Context, in *comm.Empty, opts ...grpc.CallOption) (*BookDeleteHistoryListReply, error)
}
...
func (c *bookRpcClient) BookDeleteHistoryList(ctx context.Context, in *comm.Empty, opts ...grpc.CallOption) (*BookDeleteHistoryListReply, error) {
	out := new(BookDeleteHistoryListReply)
	err := c.cc.Invoke(ctx, "/book.BookRpc/BookDeleteHistoryList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BookRpcServer interface {
	...
	BookDeleteHistoryList(context.Context, *comm.Empty) (*BookDeleteHistoryListReply, error)
}
...
func (*UnimplementedBookRpcServer) BookDeleteHistoryList(context.Context, *comm.Empty) (*BookDeleteHistoryListReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BookDeleteHistoryList not implemented")
}
...
func _BookRpc_BookDeleteHistoryList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(comm.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BookRpcServer).BookDeleteHistoryList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/book.BookRpc/BookDeleteHistoryList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookRpcServer).BookDeleteHistoryList(ctx, req.(*comm.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _BookRpc_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BookDeleteHistoryList",
			Handler:    _BookRpc_BookDeleteHistoryList_Handler,
		},
	},
